...
<div id="container">
    ...
    <div style="text-align:center;margin-top:50px;">
        <div id="pboxL">
            <h3 style="font-weight:bold;"><br>
                <?php echo $tasklabel; ?></h3>
        </div>
...
<div id="footer">
    ...
    <form method="POST" action="getit.php" id="movenext">
        <div style="float:right;margin-right:10px;margin-top:10px;">
            <input type="submit" value="<?php echo $pagetexts['forward']; ?>" style="color:#093;cursor:pointer;background:#ddd;font-size:20px;padding:1px;font-weight:bold;">
        </div>
    </form>
